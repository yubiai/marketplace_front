...
const PriceItemEdit = ({ dataCurrencySymbolPrice, dataPrice, dataUbiBurningamount }) => {
    ...
    const onSubmit = async () => {
        console.log("on submit", selectedCurrency, priceValue)
        reset();
        setActionEdit(false);
    }
    ...
    return (
        <>
            ...
            {!actionEdit && (<Text>Currency: {dataCurrencySymbolPrice} {" - "} Price: {dataPrice} {dataCurrencySymbolPrice}  {" - Ubi Burn: " + dataUbiBurningamount + "%"}</Text>)}
