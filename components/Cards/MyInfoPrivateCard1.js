import { Box, Button, Center, Heading, Flex, Image, Stack, Text, Link, Divider } from '@chakra-ui/react'
import { useRouter } from 'next/router'

const MyInfoPrivateCard1 = ({ dataProfile, t }) => {
...
export default MyInfoPrivateCard1
