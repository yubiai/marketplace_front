    ...
    <>
      ...
      <Container maxW="2xl" display={'flex'} flexDirection={'column'}>
        ...
        <Box mt="1em">
          ...
          <Flex m="5px" fontStyle={"italic"}>{t("Characters")} <Text color={countTitle < MIN_TITLE_LENGTH || countTitle > MAX_TITLE_LENGTH ? "black.500" : "green"} mr="5px" ml="5px">{countTitle}</Text> / {MAX_TITLE_LENGTH}</Flex>
        </Box>
        <Box mt="1em">
