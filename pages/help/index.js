  ...
  return (
    <>
      ...
      >
        ...
        <Text ml="2px" mt="10px" color="black">{t("For any support/suggestions please reach us at")} <Link href="mailto:contact@yubiai.market"><Button padding="0px" bg="transparent" h="0px" color="#00abd1">contact@yubiai.market</Button></Link></Text>
