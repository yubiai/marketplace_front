  ...
  return (
    <>
      ...
      <Container
        ...
        p={4}
      >
        <Heading mt="10px">{t("faq.Help")}</Heading>
        <Text ml="2px" mt="10px" color="black">{t("faq.subtitle")} <Link href="mailto:contact@yubiai.market"><Button padding="0px" bg="transparent" h="0px" color="#00abd1">contact@yubiai.market</Button></Link></Text>
        ...
        >
          <Heading>
            <Text>{t("faq.What is Yubiai?")}</Text>
          </Heading>
          <Text mt="5px">
            {t("faq.Yubiai is a decentralized marketplace that allows any people registered in proof of humanity to buy and sell everything using crypto.")}
          </Text>
          <Heading mt="10px">
            <Text>{t("faq.How do I use Yubiai?")}</Text>
          </Heading>
          <Text mt="5px" >
            {t("faq.If you are already registered in Proof Of Humanity you can connect with your wallet from PoH on app.yubiai.market and start using the platform, if not just go ahead to https://app.proofofhumanity.id/, create a new metamask wallet and register.")}
          </Text>
          <Heading mt="10px">
            <Text >{t("faq.How does Yubiai work?")}</Text>
          </Heading>
          <Text mt="5px" >
            {t("faq.Yubiai has three layers of security, one is proofofhumanity as identity and authentication method, the other ones are Kleros Escrow, dispute resolution and curate. PoH acts a sybil resistance mechanism so you know that you are transactioning with a real human, the kleros escrow holds the payment of every transaction and if anything goes well it releases the payment to the seller or if anything goes sideways the dispute resolver kicks in and a juror will decide upon evidence how to rule. And there is the last mechanism that is curate, in every submission of an item, if it's inside the scope or regulations of each country and specifications of submission your item will be published if not it will get rejected.")}
          </Text>
          <Heading mt="10px">
            <Text >{t("faq.I want to invest. Are you raising funds?")}</Text>
          </Heading>
          <Text mt="5px" >
            {t("faq.Yes, we are. Please, email us so we can discuss further these opportunities.")}
          </Text>
          <Heading mt="10px">
            <Text >{t("faq.How much you have raised so far?")}</Text>
          </Heading>
          <Text mt="5px" >
